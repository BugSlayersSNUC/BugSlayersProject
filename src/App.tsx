...
export default function App() {
  ...
  const circleLivesImpacted = useMemo(() => 
    activeCircle.donations.filter(d => d.status === 'verified').length * 3,
  [activeCircle]);
  ...
  const handleAddDonation = (newDonation: any) => {
    setActiveCircle(prev => ({
      ...
      activityScore: Math.min(100, prev.activityScore + 10)
    }));
  };
        ...
        <div className="mt-auto flex flex-col gap-4">
          <div className="glass-card p-4 rounded-2xl">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <p className="text-sm font-bold">Mukhil Raj</p>
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-xl">
              ...
              <select 
                ...
                className="bg-transparent border-none text-[10px] font-bold uppercase tracking-widest text-white focus:outline-none cursor-pointer ml-auto"
              >
        ...
        <AnimatePresence mode="wait">
          {currentView === 'dashboard' ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                      <StatCard icon={<Droplets className="text-red-500" />} label="Total Units" value="24.5L" />
                      <StatCard icon={<TrendingUp className="text-green-500" />} label="Weekly Growth" value="+12%" />
                      <StatCard icon={<Award className="text-yellow-500" />} label="Circle Rank" value="#4" />
                    </div>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    <AnimatePresence mode="popLayout">
                      {activeCircle.donations.map((donation, idx) => (
                        <motion.div
                          key={donation.id}
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
            >
              <Rewards circle={activeCircle} onUpdateCircle={(updated) => {
